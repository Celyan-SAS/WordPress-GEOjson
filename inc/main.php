...
echo "<pre>", print_r("'_POSTvisible'", 1), "</pre>";
echo "<pre>", print_r(stripslashes($_POST['visible']), 1), "</pre>";
echo "<pre>", print_r("sqdfqsf", 1), "</pre>";
echo "<pre>", print_r(json_decode(stripslashes($_POST['visible'])), 1), "</pre>";
